      ...
      <div class="show">
          ...
          <div class="biaoge">
            <div class="one">
               ...
               <div class="right">
                 <span>*性别</span>
                 <select v-model="form.sex" name="sex" id="" class="seled">
            ...
            <div class="one">
               <div class="left">
                 <span>*移动电话</span>
                 <input v-model="form.tele" type="text" name="name" id=""  required>
               </div>
               <div class="right">
                 <span>*电子邮箱</span>
